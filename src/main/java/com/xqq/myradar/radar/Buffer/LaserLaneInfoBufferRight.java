...
@Component
public class LaserLaneInfoBufferRight {
    @Autowired
    ...
    private  static LaserLaneInfoBufferRight laneInfoBuffer=new LaserLaneInfoBufferRight();
    public LaserLaneInfoBufferRight(){};

    public static LaserLaneInfoBufferRight getS(){
...
//        System.out.println("laneInfoList = this.laneInfoMapper.selectAll(tableName)"+laneInfoList);
